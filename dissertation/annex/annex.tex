...
% Modify figure and table numbering for annex, making them follow the same sequence
\setcounter{figure}{0}  % Reset the figure counter at the start of the annex
\setcounter{table}{0}   % Reset the table counter at the start of the annex
\renewcommand{\thefigure}{\Alph{section}.\arabic{figure}}  % Number figures as A.1, A.2, etc.
\renewcommand{\thetable}{\Alph{section}.\arabic{table}}  % Number tables as A.1, A.2, etc.

% Manually increment the same counter for both figures and tables
\newcounter{annexcounter}
\setcounter{annexcounter}{0}  % Initialize the shared counter
...
\begin{sidewaysfigure}[h]
    \centering
    \includegraphics[width=1.0\textwidth]{chapters/avatar_creation_pose_synthesis/images/classes_animator.pdf}
