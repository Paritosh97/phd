...
Video~\footnote{\url{https://www.phd.paritosh-sharma.com/dissertation/ch6_all_aus.mp4}} shows the range of all the blendshapes in AZee\s morph set. Video~\footnote{\url{https://www.phd.paritosh-sharma.com/dissertation/ch6_all_expressions.mp4}} shows all the synthesized facial expressions with their interpolations.
