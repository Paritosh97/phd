...
\begin{figure}
    ...
    \begin{tabular}{|c|c|}
        ...
        \hline
        % Finger Morphs
        \texttt{index\_bend\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/index_bend_L.png} \\ 
        \texttt{middle\_bend\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/middle_bend_L.png} \\ 
        \texttt{ring\_bend\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/ring_bend_L.png} \\ 
        \texttt{little\_bend\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/little_bend_L.png} \\ 
        \texttt{index\_bend\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/index_bend_R.png} \\ 
        \texttt{middle\_bend\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/middle_bend_R.png} \\ 
        \texttt{ring\_bend\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/ring_bend_R.png} \\ 
        \texttt{little\_bend\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/little_bend_R.png} \\ 
        \texttt{index\_hook\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/index_hook_L.png} \\ 
        \texttt{middle\_hook\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/middle_hook_L.png} \\ 
        \texttt{ring\_hook\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/ring_hook_L.png} \\ 
        \texttt{little\_hook\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/little_hook_L.png} \\ 
        \texttt{index\_hook\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/index_hook_R.png} \\ 
        \texttt{middle\_hook\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/middle_hook_R.png} \\ 
        \texttt{ring\_hook\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/ring_hook_R.png} \\ 
        \texttt{little\_hook\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/little_hook_R.png} \\ 
        \texttt{thumb\_bend\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/thumb_bend_L.png} \\ 
        \texttt{thumb\_hook\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/thumb_hook_L.png} \\ 
        \texttt{thumb\_opposed\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/thumb_opposed_L.png} \\ 
        \texttt{thumb\_bend\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/thumb_bend_R.png} \\ 
        \texttt{thumb\_hook\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/thumb_hook_R.png} \\ 
        \texttt{thumb\_opposed\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/thumb_opposed_R.png} \\ 
        \texttt{fingers\_spread\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/fingers_spread_L.png} \\ 
        \texttt{fingers\_spread\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/fingers_spread_R.png} \\ 
        \hline
        % Body Posture Morphs
        \texttt{shoulder\_raise\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/shoulder_raise_L.png} \\ 
        \texttt{shoulder\_raise\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/shoulder_raise_R.png} \\ 
        \texttt{shoulder\_shrug\_L} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/shoulder_shrug_L.png} \\ 
        \texttt{shoulder\_shrug\_R} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/shoulder_shrug_R.png} \\ 
        \texttt{spine\_extended} & \includegraphics[width=0.15\textwidth]{chapters/avatar_creation_pose_synthesis/images/morph_renders/spine_extended.png} \\ 
        \hline
    \end{tabular}
...
The animation time compared to the previous synthesizer are shown in table~\ref{tab:faster_executions}.
